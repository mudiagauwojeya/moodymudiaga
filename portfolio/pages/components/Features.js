...
import styles from '../../sass/layout/Features.module.scss'
      ...
      <section className={styles.feature}>
        <div className={styles.feature__features1}>
          ...
          <div className={styles.feature__description}>
            ...
            <p className={styles.feature__highlight}>
              boost your online presence by ranking top in search results to get
              more leads, sales, and save on ads
            </p>
          </div>
        </div>
        ...
        <div className={styles.feature__features2}>
          ...
          <div className={styles.feature__description}>
            ...
            <p className={styles.feature__highlight}>
              because nobody waits for a slow website, a fast performing website
        ...
        <div className={styles.feature__features3}>
          ...
          <div className={styles.feature__description}>
            ...
            <p className={styles.feature__highlight}>
              responsive design to include the billions of customers now
        ...
        <div className={styles.feature__features4}>
          ...
          <div className={styles.feature__description}>
            ...
            <p className={styles.feature__highlight}>
              make your website accessible to all kinds of visitors, including
